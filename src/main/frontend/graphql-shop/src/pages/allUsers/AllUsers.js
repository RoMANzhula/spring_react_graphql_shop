  ...
  return (
    <div>
      <div className="container">
        ...
        <label style={{ marginRight: '2px', marginLeft: '15px' }}>Users Per Page: </label>
        ...
        <label style={{marginLeft: '15px'}}>Search by ID: </label>
        <input type="text" value={searchId} onChange={(e) => setSearchId(e.target.value)} size="1" />
